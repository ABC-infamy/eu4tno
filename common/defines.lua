...
NDiplomacy = {
	...
	PO_DEMAND_PROVINCES_AE = 0.01, 				-- _DDEF_PO_DEMAND_PROVINCES_AE = 10, (Per development)
	...
	PEACE_COST_DEMAND_PROVINCE = 0.01,					-- Demand a province (scales by province wealth, also used for annex)
